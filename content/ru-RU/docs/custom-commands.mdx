...
## Создайте класс команды с параметрами
...
## Зарегистрируйте команду в onEnable
...
Нужны дополнительные примеры? [ExamplePlugin/command](https://github.com/LuminiaDev/ExamplePlugin/tree/master/src/main/java/com/luminiadev/exampleplugin/command)
